...
//            System.out.println(sentences);
            ...
            for(  Map<String, Object> sentence : sentences ) {
                ...
                for( Map<String, Object> rayInfo : rayRecognitionResult ) {
                    ...
                    if (rayEntity == null && (name.contains("자외선") || name.equals("습도"))) {
...
//        buffer.append("wsl.exe sh -c \"");
//        buffer.append("/c ");
//        buffer.append(cmd);
        buffer.append("wsl.exe sh -c \"cd /mnt/c/Users/USER/git/Hwaxby/Model && python3 infer-v2.py '"+cmd+"' > /dev/null 2>&1 && cat /mnt/c/Users/USER/git/Hwaxby/Model/output\"");
