  ...
  ask = async() => {
    ...
    Geolocation.getCurrentPosition( async({ coords }) => {
      ...
      this.setState({
        ...
        Info: resResponse.data.display.Info,
      ...
      this.play();
      console.log('done');
      console.log('info: ', resResponse.data.display.Info);
    });
  };
        ...
        <SafeAreaView style={styles.mainContainer}>
          ...
          {isFirst ? (
            ...
            <View style={styles.main}>
              <ImageBackground style={styles.backImage} source={{ uri: 'https://crashwriter.files.wordpress.com/2013/04/blueskiesbycrash.png'}}>
            <View style={styles.topWeather}>
            <View style={styles.childTopWeather}>
            <Text style={styles.dtsText}>{dts}</Text>
          ...
          <View style={styles.centerWeather}>
            ...
            <Text style={styles.boldWeatherText}>강수량</Text>
              <Text style={styles.blackweatherText}>{rain}</Text>
            </View>
            <View style={styles.childCenterWeather}>
            <Text style={styles.boldWeatherText}>습도</Text>
              <Text style={styles.blackweatherText}>{humidity}%</Text>
            </View>
            <View style={styles.childCenterWeather}>
            <Text style={styles.boldWeatherText}>풍속</Text>
              <Text style={styles.blackweatherText}>{wind}m/s</Text>
            </View>
            <View style={styles.childCenterWeather}>
            <Text style={styles.boldWeatherText}>체감온도</Text>
              <Text style={styles.blackweatherText}>{feeling}°C</Text>
            </View>
            <View style={styles.childCenterWeather}>
            <Text style={styles.boldWeatherText}>일출/일몰</Text>
              <Text style={styles.blackweatherText}>{sunRise}/{sunFall}</Text>
            </View>
          </View>
